...
const isSavedMessage = <div className='text-light'>
  ...
  <p>Go back to the <a href="/" className='text-decoration-none'>home</a> page?</p></div>
...
getDownloadURL(userImg)
  ...
  <input type="file" className="form-control" id="inputGroupFile02" onChange={e => setImgFile(e.target.files[0])}/>
</div>
